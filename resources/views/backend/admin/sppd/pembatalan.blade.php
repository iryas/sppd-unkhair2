...
@section('content')
    <div>
        ...
        <section class="content pl-2 pr-2">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button class="btn btn-sm btn-danger" onclick="pembatalan()">
                            <i class="fa fa-search"></i> Pembatalan SPPD
                        </button>
                            ...
                            <table class="table table-condensed table-bordered" style="width: 100%"
                                ...
                                <thead class="warna-warning">
                                    <tr>
                                        ...
                                        <th class="text-left">Tgl. Pembatalan</th>
        ...
        <livewire:sppd.pembatalan />

        <!-- /.content -->
        @push('script')
            <script>
                function pembatalan() {
                    Livewire.dispatch('pembatalan-sppd');
                }
            </script>
        @endpush
    </div>
