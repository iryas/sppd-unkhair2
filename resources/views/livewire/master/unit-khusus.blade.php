            ...
            <form wire:submit.prevent="save">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" wire:model="unitpusat" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Unit Bagian<sup
                                class="text-danger">*</sup> :</label>
                        <input type="text" class="form-control" wire:model="unit_bagian" placeholder="Unit Bagian">
                        @error('unit_bagian')
